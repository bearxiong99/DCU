...
#define CONF_CONTEXT_INFORMATION_TABLE_0 (const uint8_t *) "\x00\x02" "\x01" "\x50" "\xFE\x80\x00\x00\x00\x00\x00\x00\x78\x1D"

// Context information table: index 1 (Context 1 with value �112233445566� (length = 48))
#define CONF_CONTEXT_INFORMATION_TABLE_1 (const uint8_t *) "\x00\x02" "\x01" "\x30" "\x11\x22\x33\x44\x55\x66"

// Routing table entry TTL (2 bytes, little endian) (180 minutes)
#define CONF_ROUTING_TABLE_ENTRY_TTL (const uint8_t *) "\x00\xB4"
...
#define CONF_GROUP_TABLE_0 (const uint8_t *) "\x85\x67"
