...
typedef enum {
    FUP_STATE_IDLE        = 0,
    FUP_STATE_RECEIVING   = 1,
    FUP_STATE_COMPLETE    = 2,
    FUP_STATE_COUNTDOWN   = 3,
    FUP_STATE_UPGRADED    = 4,
    FUP_STATE_EXCEPTION   = 5,
    FUP_STATE_CONFIRMED   = 128
} x_fup_state_t;
...
typedef void (*prime_cl_null_establish_ind_cb_t)(uint16_t us_con_handle, uint8_t *puc_eui48, uint8_t uc_type, uint8_t *puc_data,
                                                 uint16_t us_data_len, uint8_t uc_cfbytes);
...
typedef void (*prime_cl_null_establish_cfm_cb_t)(uint16_t us_con_handle, mac_establish_confirm_result_t uc_result,
        uint8_t *puc_eui48, uint8_t uc_type, uint8_t *puc_data, uint16_t us_data_len);
 ...
 * - us_data_len:          Length of the data in bytes
 */
typedef void (*prime_cl_null_join_ind_cb_t)(uint16_t us_con_handle, uint8_t *puc_eui48, uint8_t uc_con_type, uint8_t *puc_data, uint16_t us_data_len);
 ...
 */
typedef void (*prime_cl_null_join_cfm_cb_t)(uint16_t us_con_handle, mac_join_confirm_result_t uc_result);
 ...
 * - us_data_len:      Length of the data in bytes
 */
typedef void (*prime_cl_null_data_ind_cb_t)(uint16_t us_con_handle, uint8_t *puc_data, uint16_t us_data_len);
 ...
 */
typedef void (*prime_cl_432_establish_cfm_cb_t)(uint8_t *puc_device_id, uint8_t uc_device_id_len, uint16_t us_dst_address, uint16_t us_base_address);
 ...
 */
typedef void (*prime_cl_432_dl_join_ind_cb_t)(uint8_t *puc_device_id, uint8_t uc_device_id_len, uint16_t us_dst_address, uint8_t *puc_mac);
