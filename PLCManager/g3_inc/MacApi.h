...
struct TMcpsDataIndication {
  ...
  struct TPhyToneMap m_RecvToneMap;
  uint8_t m_u8ComputedModulation;
  uint8_t m_u8ComputedModulationScheme;
  struct TPhyToneMap m_ComputedToneMap;
};
...
/**********************************************************************************************************************/
/** The MacMcpsDataRequest primitive requests the transfer of an application PDU to another device or multiple devices.
...
/**********************************************************************************************************************/
/** The MacMlmeResetConfirm primitive allows the upper layer to be notified of the completion of a MacMlmeResetRequest.
 ***********************************************************************************************************************
