...
int main(int argc, char *argv[])
{
	...
	printf("Enabling ERASE pin\n");
	gpioexport(2);
	gpiosetdir(2,GPIO_OUT);
	gpiosetbits(2);
	usleep(300000);
	printf("Disabling ERASE pin\n");
	gpioclearbits(2);

	printf("Reset SAM\n");
	gpioexport(4);
	gpiosetdir(4,GPIO_OUT);
	gpioclearbits(4);
	usleep(300000);
	gpiosetbits(4);
